...
{    
    ...
    icon_size = 32,
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "advanced-incinerator"},
    max_health = 200,
    corpse = "small-remnants",
    vehicle_impact_sound =  { filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65 },
    mode = "output-to-separate-pipe",
    ...
    structure =
    {
      north =
      {
        ...
        {
          {
            filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-N-idle.png",
            priority = "extra-high",
            width = 131,
            height = 108,
            shift = util.by_pixel(-0.5, 4),
            hr_version = {
              filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-N-idle.png",
              priority = "extra-high",
              width = 269,
              height = 221,
              shift = util.by_pixel(-1.25, 5.25),
          ...
          {
            filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-N-shadow.png",
            priority = "extra-high",
            width = 137,
            height = 82,
            shift = util.by_pixel(20.5, 9),
            draw_as_shadow = true,
            hr_version = {
              filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-N-shadow.png",
              priority = "extra-high",
              width = 274,
              height = 164,
              scale = 0.5,
      ...
      east =
      {
        ...
        {
          {
            filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-E-idle.png",
            priority = "extra-high",
            width = 105,
            height = 147,
            shift = util.by_pixel(-3.5, -0.5),
            hr_version = {
              filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-E-idle.png",
              priority = "extra-high",
              width = 216,
              height = 301,
              shift = util.by_pixel(-3, 1.25),
          ...
          {
            filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-E-shadow.png",
            priority = "extra-high",
            width = 92,
            height = 97,
            shift = util.by_pixel(30, 9.5),
            draw_as_shadow = true,
            hr_version = {
              filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-E-shadow.png",
              priority = "extra-high",
              width = 184,
              height = 194,
              scale = 0.5,
      ...
      south =
      {
        ...
        {
          {
            filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-S-idle.png",
            priority = "extra-high",
            width = 128,
            height = 95,
            shift = util.by_pixel(3, 12.5),
            hr_version = {
              filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-S-idle.png",
              priority = "extra-high",
              width = 260,
              height = 192,
              shift = util.by_pixel(4, 13),
          ...
          {
            filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-S-shadow.png",
            priority = "extra-high",
            width = 156,
            height = 66,
            shift = util.by_pixel(30, 16),
            draw_as_shadow = true,
            hr_version = {
              filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-S-shadow.png",
              priority = "extra-high",
              width = 311,
              height = 131,
              scale = 0.5,
      ...
      west =
      {
        ...
        {
          {
            filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-W-idle.png",
            priority = "extra-high",
            width = 96,
            height = 132,
            shift = util.by_pixel(1, 5),
            hr_version = {
              filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-W-idle.png",
              priority = "extra-high",
              width = 196,
              height = 273,
              shift = util.by_pixel(1.5, 7.75),
          ...
          {
            filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-W-shadow.png",
            priority = "extra-high",
            width = 103,
            height = 109,
            shift = util.by_pixel(19.5, 6.5),
            draw_as_shadow = true,
            hr_version = {
              filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-W-shadow.png",
              priority = "extra-high",
              width = 206,
              height = 218,
              scale = 0.5,
    ...
    patch =
    {
      east =
      {
        filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-E-patch.png",
        priority = "extra-high",
        width = 3,
        height = 17,
        shift = util.by_pixel(33.5, -13.5),
        hr_version = {
          filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-E-patch.png",
          width = 6,
          height = 36,
          shift = util.by_pixel(33.5, -13.5),
          scale = 0.5
    ...
    fire =
    {
      north =
      {
        filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-N-fire.png",
        priority = "extra-high",
        frame_count = 64,
        line_length = 8,
        width = 12,
        ...
        shift = util.by_pixel(0, -8.5),
        hr_version = {
          filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-N-fire.png",
          priority = "extra-high",
          frame_count = 64,
          line_length = 8,
          width = 26,
      ...
      east =
      {
        filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-E-fire.png",
        priority = "extra-high",
        frame_count = 64,
        line_length = 8,
        width = 14,
        ...
        shift = util.by_pixel(-10, -22),
        hr_version = {
          filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-E-fire.png",
          priority = "extra-high",
          frame_count = 64,
          line_length = 8,
          width = 28,
      ...
      south =
      {
        filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-S-fire.png",
        priority = "extra-high",
        frame_count = 64,
        line_length = 8,
        width = 12,
        ...
        shift = util.by_pixel(-1, -26.5),
        hr_version = {
          filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-S-fire.png",
          priority = "extra-high",
          frame_count = 64,
          line_length = 8,
          width = 26,
      ...
      west =
      {
        filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-W-fire.png",
        priority = "extra-high",
        frame_count = 64,
        line_length = 8,
        width = 14,
        ...
        shift = util.by_pixel(13, -23),
        hr_version = {
          filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-W-fire.png",
          priority = "extra-high",
          frame_count = 64,
          line_length = 8,
          width = 30,
    ...
    fire_glow =
    {
      north =
      {
        filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-N-light.png",
        priority = "extra-high",
        frame_count = 1,
        width = 100,
        height = 87,
        ...
        blend_mode = "additive",
        hr_version = {
          filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-N-light.png",
          priority = "extra-high",
          frame_count = 1,
          width = 200,
          height = 173,
      ...
      east =
      {
        filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-E-light.png",
        priority = "extra-high",
        frame_count = 1,
        width = 70,
        height = 122,
        ...
        blend_mode = "additive",
        hr_version = {
          filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-E-light.png",
          priority = "extra-high",
          frame_count = 1,
          width = 139,
          height = 244,
      ...
      south =
      {
        filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-S-light.png",
        priority = "extra-high",
        frame_count = 1,
        width = 100,
        height = 81,
        ...
        blend_mode = "additive",
        hr_version = {
          filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-S-light.png",
          priority = "extra-high",
          frame_count = 1,
          width = 200,
          height = 162,
      ...
      west =
      {
        filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/boiler-W-light.png",
        priority = "extra-high",
        frame_count = 1,
        width = 68,
        height = 109,
        ...
        blend_mode = "additive",
        hr_version = {
          filename = "__Advanced-WasteManagement__/graphics/entity/advanced-incinerator/hr-boiler-W-light.png",
          priority = "extra-high",
          frame_count = 1,
          width = 136,
          height = 217,
